            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group label-floating is-empty">
                        ...
                        <textarea name="note" type="text" id="note" required="true" aria-required="true"></textarea>
                        <span class="material-input"></span>
                    </div>
                    ...
                    <div class="form-group label-floating is-empty">
                        ...
                        <input class="form-control" name="warranty" type="number" id="warranty" required="true"
                            aria-required="true">
                        <span class="material-input"></span>
                    </div>
            ...
            $(document).on('click', '#detail', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        detail.summernote('code', data.content);
