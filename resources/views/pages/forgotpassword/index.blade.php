                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary mt-3 d-block w-100"
                                            id="submit">Đặt lại mật khẩu</button>
                                    </div>
                                </div>
                                <p class="font-monospace fw-medium text-center text-muted mt-3 pt-4 mb-0">Đã có tài khoản? <a href="{{route('login')}}" class="text-decoration-none">Đăng nhập ngay</a>
                                    <br>
                                </p>
                            </form>
                        </div>
            ...
            $("#submit").on("click", function(e) {
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: 'Đặt lại mật khẩu thành công. Vui lòng kiểm tra email'
                        })
                    },
                    error: function(e) {
                        const Toast = Swal.mixin({
